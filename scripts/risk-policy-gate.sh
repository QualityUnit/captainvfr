...
classify_file() {
  ...
  # Tier 3: Critical paths from harness.config.json
  case "$file" in
    pubspec.yaml|pubspec.lock)                        echo 3; return ;;
    package.json|package-lock.json)                   echo 3; return ;;
    android/build.gradle.kts|android/app/build.gradle) echo 3; return ;;
    ios/Podfile|ios/Podfile.lock)                     echo 3; return ;;
    macos/Podfile|macos/Podfile.lock)                 echo 3; return ;;
    .github/workflows/*.yml|.github/workflows/*.yaml) echo 3; return ;;
    android/key.properties)                           echo 3; return ;;
    ios/GoogleService-Info.plist)                     echo 3; return ;;
    build_release.sh|release_ios.sh|release_android.sh) echo 3; return ;;
  esac

  # Tier 2: Source code, tests, scripts, assets, platform code
  case "$file" in
    lib/*.dart)           echo 2; return ;;
    test/*.dart)          echo 2; return ;;
    scripts/*.dart)       echo 2; return ;;
    scripts/*.sh)         echo 2; return ;;
    scripts/*.py)         echo 2; return ;;
    assets/*)             echo 2; return ;;
    web/*)                echo 2; return ;;
    ios/*)                echo 2; return ;;
    android/*)            echo 2; return ;;
    macos/*)              echo 2; return ;;
    l10n.yaml)            echo 2; return ;;
    analysis_options.yaml) echo 2; return ;;
    devtools_options.yaml) echo 2; return ;;
    .metadata)            echo 2; return ;;
    amplify.yml)          echo 2; return ;;
    amplify/*)            echo 2; return ;;
  esac

  # Tier 1: Documentation, markdown, non-code config
  case "$file" in
    *.md)          echo 1; return ;;
    docs/*)        echo 1; return ;;
    hugo/*)        echo 1; return ;;
...
compute_required_checks() {
  case "$MAX_TIER" in
    1)
      ...
      ;;
    2)
      REQUIRED_CHECKS=("lint" "test" "build" "harness-smoke")
      ;;
    3)
      REQUIRED_CHECKS=("lint" "test" "build" "structural-tests" "harness-smoke" "manual-approval")
      ;;
    *)
